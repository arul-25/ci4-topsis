...
class Persyaratan_Model extends Model {
    ...
    protected $allowedFields = ['kd_persyaratan', 'nm_persyaratan', 'id_beasiswa'];
    ...
    private function _get_datatables_query(){
        $i = 0;
        $this->dt->select('persyaratan.*,beasiswa.nm_beasiswa')->join('beasiswa', 'beasiswa.id=persyaratan.id_beasiswa')->where('beasiswa.deleted_at', NULL);
