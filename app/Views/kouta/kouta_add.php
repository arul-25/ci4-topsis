       ...
       <!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h5 mb-0 text-gray-800">Form Tambah Kouta</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="table-responsive p-3">
                  <div class="col-md-6">
                    <form action="<?=base_url('dashboard/kouta_store')?>" method="post" style="margin-top: 10px;">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="number" name="kouta" class="form-control" placeholder="Kouta" value="<?php echo set_value('kouta'); ?>">
