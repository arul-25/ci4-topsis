       ...
       <!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h5 mb-0 text-gray-800">Form Tambah Beasiswa</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="table-responsive p-3">
                  <div class="col-md-6">
                    <form action="<?=base_url('dashboard/beasiswa_store')?>" method="post" style="margin-top: 10px;">
                      <div class="form-group row">
                        <label for="kd_beasiswa" class="col-sm-4 col-form-label">Kode Beasiswa</label>
                        <div class="col-sm-8">
                          <input type="text" name="kd_beasiswa" class="form-control" placeholder="Kode Beasiswa" value="<?php echo set_value('kd_beasiswa'); ?>">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="nm_beasiswa" class="form-control" placeholder="Nama Beasiswa" value="<?php echo set_value('nm_beasiswa'); ?>">
