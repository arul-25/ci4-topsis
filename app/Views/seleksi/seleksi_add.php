       ...
       <!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h5 mb-0 text-gray-800">Form Tambah Seleksi</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="table-responsive p-3">
                  <div class="col-md-6">
                    <form action="<?=base_url('dashboard/seleksi_store')?>" method="post" style="margin-top: 10px;">
                      <div class="form-group row">
                        <label for="kd_seleksi" class="col-sm-4 col-form-label">Kode Seleksi</label>
                        <div class="col-sm-8">
                          <input type="text" name="kd_seleksi" class="form-control" placeholder="Kode Seleksi" value="<?php echo set_value('kd_seleksi'); ?>">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="thn_akademik" class="form-control" placeholder="Tahun Akademik" value="<?php echo set_value('thn_akademik'); ?>">
                            ...
                            <select class="select2-single-placeholder2 form-control" name="id_mahasiswa">
                              ...
                              <?php
                                    foreach($mahasiswa as $rowm){
                                      echo '<option value="'.$rowm['id'].'">['.$rowm['npm'].'] '.$rowm['nama'].'</option>';
                                    }
                              ?>
                            </select>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="date" name="tgl_seleksi" class="form-control" placeholder="Tanggal Seleksi" value="<?php echo date('Y-m-d'); ?>">
